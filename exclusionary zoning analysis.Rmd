---
title: "Detached, large lot zoning is a relic of Jim Crow. It's time to abolish it."
...
Today, homes in the areas the FHA reserved for rich white people ("grade A") sell for 4 times more than homes in the lowest graded areas. "A" and "B" areas remain disproportionately white, while "G" and "H" areas are nearly 90% black.
...
R-1 zoning overlaps significantly with FHA's former "whites only" zones. Most "A" and "B" grade areas are R-1 zoned today, while few "G" and "H" areas receive this designation.
...
The map below shows the overlap between former FHA grades and current R-1 zoning, plus average home prices, discriminatory covenant locations, and 1940s Black residential areas.

Use checkboxes to toggle layers; click and drag to navigate.
