...
DC's current zoning handbook even uses verbiage that echoes segregationist tracts from the 20th century. R-1 zones are intended to "Protect quiet residential areas." R-2 zoning is supposed to "Protect these areas from invasion by denser types of residential development." 
...
Land-use policymakers should stop worrying about "protecting" certain neighborhoods from "invasion." It's time to do what the experts recommend, and delete DC's segregative R-1 and R-2 zones.
