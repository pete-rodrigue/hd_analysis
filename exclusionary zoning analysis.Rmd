---
title: "Detached, large lot zoning is relic of Jim Crow. It's time to abolish it."
...
This short write up explores the relationship between the Federal Housing Administration's neighborhood grades from the 1930s, which were explicitly racist, and DC's current-day population trends and zoning policies. The gist is that "A", "B", and "C" grades were supposed to be for rich white neighborhoods, and the other grades were for moderate-to-lower-income and/or more racially heterogeneous neighborhoods, and black neighborhoods. The ranking all the way down to "H." H was FHA's lowest grade.  You can read more about these grades at [Mapping Segregation DC](https://www.mappingsegregationdc.org/download/residential-sub-areas-for-website-rev.pdf). 
...
Today, the homes in the areas the FHA deemed were for rich white people ("grade A") sell for 3.4 times as much as homes in the lowest graded areas ("grade H"). The "A" and "B" grade areas remain disproportionately white, while the "G" and "H" grade areas have almost 90% black residents.
...
DC's Office of Planning and its Zoning Commission perpetuate this segregation, by allowing the rich, disproportionately white residents of Northwest DC to wield a powerful land-use tool, R-1 zoning, to block more affordable forms of housing in their neighborhoods (e.g. duplexes, fourplexes, apartment buildings). R-1 zoning outlaws these more affordable housing types.

As the charts below show, R-1 zoning overlaps significantly with the FHA's old "whites only" zones. The majority of both the "A" and "B" grade areas are R-1 zoned today. Conversely, very little of the old "G" and "H" grade areas have been given R-1 zoning. 
...
Here's [Eleanor Noble](https://www.urban.org/sites/default/files/2022-09/Understanding%20Historic%20Exclusion_Noble%20Testimony.pdf) of the Urban Institute speaking to the DC Zoning Commission in 2022:
...
Here's [Yesim Sayin](https://www.dcpolicycenter.org/publications/single-family-zoning-2019/), the director of the DC Policy Center, in 2019:
...
Here's [Lance Freeman](https://www.brookings.edu/articles/build-race-equity-into-rezoning-decisions/) of Columbia University in 2021:
...
And here's what DC's current [zoning handbook](https://handbook.dcoz.dc.gov/pages/residential-r-zones) says is the purpose of the R-1 zone:
...
Land-use policymakers should stop worrying about "protecting" certain neighborhoods from "invasion." It's time to do what the experts recommend, and delete DC's R-1 and R-2 zones, because they're furthering socioeconomic segregation.

<br><br>

The map below lets you see the overlap between the former FHA grades and modern R-1 zoning. It also shows average home sale prices, the approximate locations of past discriminatory covenants, and where many black residents lived in the 1940s. 

Click the check boxes to show/hide different layers. Click and drag to navigate the map.

<br>


```{r final_map, out.width="100%"}
####################
# MAP EVERYTHING
####################
pdheat <- 
