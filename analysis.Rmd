...
* [Unification Church](https://dc.urbanturf.com/pipeline/1233/1610_Columbia_Road_NW)
* [Third Church of Christ Scientist](https://ggwash.org/view/27951/the-preservation-process-failed-third-church) downtown.
* 

Looking at the demographic trends, it's hard not to conclude they are likely exacerbating gentrification as well. For more on the socioeconomic impacts of HDs, please see the literature review.
...
When we impose these restrictions, the results are similar to the main results, although the differences for the percentage of black and white residents largely disappear for the smaller buffer sizes. See below. 
...
p2 <- ggplot(my_plt) +
  ...
  ggtitle("After designation, HDs saw relative decline in black residents") +
  ylim(c(0, max(my_plt$pct_black*100, na.rm=T)+10)) +
  labs(caption = create_caption("pct_black")) +
  theme(plot.caption = element_text(hjust = 0))
...
p3 <- ggplot(my_plt) +
  ...
  ggtitle("After designation, HDs saw relative increase in white residents") +
  ylim(c(0, max(my_plt$pct_white*100, na.rm=T)+10)) +
  labs(caption = create_caption("pct_white"))
```
