...
get_geos_in_hd <- function(shp, min_pct, year) {
  # Function parameters:
  # shp: the tract or block shapefile (an sf shapefile object) containing demographic data
  # min_pct: minimum % of the tract/block that must be in the HD to count as part of the HD 
  #          (decimal between 0 and 1, e.g., 0.5 for 50%)
  # year: the year of analysis (integer like 1980)
